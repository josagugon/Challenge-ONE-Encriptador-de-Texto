...
const inputTexto = document.querySelector(".textoDeEntrada");
...
function encriptar(textoEncriptada){
    ...
    var textoEncriptada = textoEncriptada.toLowerCase();
...
function desencriptar(textoDesencriptada){
    let matrizCodigo = [["e","enter"],["i","imes"],["a","ai"],["o","ober"],["u","ufat"]];
    var textoDesencriptada = textoDesencriptada.toLowerCase();
